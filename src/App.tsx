...
const PublicHomePage = lazy(() => import('./pages/public/PublicHomePage').then((module) => ({ default: module.PublicHomePage })))
const PublicProjectsPage = lazy(() => import('./pages/public/PublicProjectsPage').then((module) => ({ default: module.PublicProjectsPage })))
const PublicProjectDetailPage = lazy(() => import('./pages/public/PublicProjectDetailPage').then((module) => ({ default: module.PublicProjectDetailPage })))
const CommunityPage = lazy(() => import('./pages/public/CommunityPage').then((module) => ({ default: module.CommunityPage })))
const CommunityDetailPage = lazy(() => import('./pages/public/CommunityDetailPage').then((module) => ({ default: module.CommunityDetailPage })))
const MyLearningPage = lazy(() => import('./pages/public/MyLearningPage').then((module) => ({ default: module.MyLearningPage })))
    ...
    <Routes>
      <Route element={<PublicExperience />}>
        ...
        <Route element={<PublicToolLayout />}>
          <Route path="/playground" element={<LazyRoute fallbackMessage="Opening the Python playground…"><PlaygroundPage /></LazyRoute>} />
